...
class ProfileBankCard extends BaseActiveRecord
{
    ...
    {
        return in_array($this->status, ProfileBankCardStatusEnum::activeStatusList());
    }
    ...
    {
        return in_array($this->status, [ProfileBankCardStatusEnum::STATUS_DRAFT->value, ProfileBankCardStatusEnum::STATUS_WAIT_FOR_APPROVE->value]);
    }
